...
The `PromptTemplateController` accepts HTTP GET requests at `http://localhost:8081/ai/roles` with three optional parameters
...
```shell
$ http GET localhost:8081/ai/roles
```
or using `curl`
```shell
curl http://localhost:8081/ai/roles
```
